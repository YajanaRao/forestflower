...
function M.load()
    ...
    -- Derive state colours (selection, search_match) from the final base values,
    -- after overrides so user base-token overrides propagate into the washes.
    themes.derive(palette)
